...
import 'package:test_stream/feed/main/text_component.dart';
import 'package:test_stream/feed/main/video_component.dart';
import 'package:test_stream/feed/scroll_detect_listener.dart';
import 'package:test_stream/feed/video_meta.dart';
      ...
      body: ScrollDetectListener(
        ...
        onVisible: (metas, model) {
          ...
          if (metas != null && metas.length > 0) {
            ...
            if (videoItem == null || (videoItem != null && videoItem != targetData)) {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, i) =>
              dataList[i].startsWith('http') ? VideoComponent(i, dataList[i]) : TextComponent(dataList[i]),
