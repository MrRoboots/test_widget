...
//           items: orderHandle.itemsWithStatus(_orderDetailModel),
//           onClickMenu: (MenuItemProvider item) {
//           },
//           onDismiss: () {},
//           maxColumn: 2);

///    _popupMenu.show(widgetKey: btnKey);
...
class MenuItems extends MenuItemProvider {
  Widget image; // 图标名称
  String title; // 菜单标题
  var userInfo; // 额外的菜单荐信息
  TextStyle textStyle;

  MenuItems({this.title, this.image, this.userInfo, this.textStyle});
