...
class BiliStartBorder extends OutlinedBorder {
  ...
  Path _getPath(RRect rrect) {
    ...
    print(
        "============== 1 : ${rrect.left}  ==  ${math.min(centerLeft.dy, rrect.top + tlRadiusY)}");
    print(
        "============== 2 : ${math.min(centerTop.dx, rrect.left + tlRadiusX)}  == ${rrect.top}");

    print(
        "============== 3 : ${math.max(centerTop.dx, rrect.right - trRadiusX)}  == ${rrect.top}");
    print(
        "============== 4 : ${rrect.right}  == ${math.min(centerRight.dy, rrect.top + trRadiusY)}");
    final List<Offset> vertices = <Offset>[
      ...
      Offset(rrect.right + 10, math.min(centerRight.dy, 20)),
      Offset(rrect.right + 10, math.max(centerRight.dy, 20)),
  ...
  bool operator ==(Object other) {
    ...
    return other is BiliStartBorder &&
        other.side == side &&
  ...
  @override
  String toString() {
    return '${objectRuntimeType(this, 'BiliStartBorder')}($side, $borderRadius)';
  }
}
